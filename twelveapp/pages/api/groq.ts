...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const { videoUrl, action, prev_title, prev_content, popoverPrompt, section_count } = req.body; //action: 'regenerate' | 'generate'
  ...
  Each sectionContent should be around 100 words in length, unless otherwise specified.  
