...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (videoUrl !== "https://www.youtube.com/watch?v=Nsx5RDVKZSk") return res.status(400).json({ error: "Can't use this video... yet" });
  ...
  Each of the values in sectionContent should be around 500 words in length, unless otherwise specified.
